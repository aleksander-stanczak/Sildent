...
import gui.AddWorkerWindow;
import gui.editors.WorkerWindow;
 ...
 * @author Aleks
 */
public class WorkerRegistryWindow extends javax.swing.JFrame {

    ArrayList<Worker> workers=null;

    /** Creates new form WorkRegistryWindow */
    public WorkerRegistryWindow() {
    ...
    private void initComponents() {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowActivated(java.awt.event.WindowEvent evt) {
                WorkerRegistryWindow.this.windowActivated(evt);
            }
        });
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nr Pracownika", "Imiê", "Nazwisko", "Pesel", "Miasto z kodem", "Ulica", "Email", "Telefon"
            }
        ) {
    ...
    private void edit(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edit
        if(table.getSelectedRow()!= -1){
            Cache.worker = workers.get(table.getSelectedRow());
    ...
    private void delete(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete
        ...
        try {
            ...
            if(table.getSelectedRow()!= -1){
                sildent.Config.conn.deleteWorker(
    ...
    private void refreshTable(){
        ...
        try {
            workers = sildent.Config.conn.getWorkerList();
            ...
            for (Worker worker : workers) {
                model.addRow(new Object[]{
                    ...
                    worker.getSurname(),
                    worker.getPesel(),
                    worker.getCity()+" "+worker.getPost_code(),
                    worker.getAddress(),                    
                    worker.getEmail(),
                    worker.getPhone_num(),
                });
