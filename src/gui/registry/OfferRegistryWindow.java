...
import gui.editors.OfferWindow;
 ...
 * @author Aleks
 */
public class OfferRegistryWindow extends javax.swing.JFrame {


    ArrayList<WorkType> workTypes=null;
    /** Creates new form WorkRegistryWindow */
    public OfferRegistryWindow() {
    ...
    private void initComponents() {
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            public void windowActivated(java.awt.event.WindowEvent evt) {
                OfferRegistryWindow.this.windowActivated(evt);
            }
        });
      ...
      System.out.println("Deleting row: "+table.getSelectedRow());
        try {
            ...
            if(table.getSelectedRow()!= -1){
                sildent.Config.conn.deleteWorkType(
    ...
    private void edit(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edit
    	if (table.getSelectedRow() != -1) {
            Cache.workType = workTypes.get(table.getSelectedRow());
            new OfferWindow(false).setVisible(true);
        }
    ...
    private void refreshTable(){
        ...
        try {
            workTypes = sildent.Config.conn.getWorkTypesList();
