 ...
 * @author Aleks
 */
public class AddWorkerWindow extends javax.swing.JFrame {
    ...
    private void saveDoctor(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveDoctor
        ...
        if(!peselField.getText().isEmpty())
           worker.setPesel(Long.parseLong(peselField.getText().trim()));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddWorkerWindow().setVisible(true);
            }
        });
    }
